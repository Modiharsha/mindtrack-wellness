          ...
          <div className="flex items-center gap-2">
            ...
            <div className="relative">
              <button
                ...
                className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl text-xs font-semibold bg-emerald-50 text-emerald-800 border border-emerald-200/80 hover:bg-emerald-100 transition-colors shadow-sm"
              >
              ...
              {showDemoMenu && (
                <div className="absolute right-0 mt-2 w-64 bg-white rounded-2xl shadow-xl border border-slate-200 p-2 z-50 animate-fadeIn">
                  ...
                  <button
                    onClick={() => handleDemoSwitch('STUDENT', 'alex.rivera@mindtrack.edu')}
                    className="w-full text-left px-3 py-2 rounded-xl text-xs hover:bg-slate-50 flex items-center justify-between text-slate-700"
                  >
                    <div>
                      <p className="font-semibold">Alex Rivera (Student)</p>
                      <p className="text-[10px] text-rose-600 font-medium">Needs Attention Flag</p>
                    </div>
                    <span className="text-[10px] bg-slate-100 px-1.5 py-0.5 rounded">Switch</span>
                  </button>

                  <button
                    onClick={() => handleDemoSwitch('STUDENT', 'jordan.lee@mindtrack.edu')}
                    className="w-full text-left px-3 py-2 rounded-xl text-xs hover:bg-slate-50 flex items-center justify-between text-slate-700"
                  >
                    <div>
                      <p className="font-semibold">Jordan Lee (Student)</p>
                      <p className="text-[10px] text-emerald-600 font-medium">Thriving / High Streak</p>
                    </div>
                    <span className="text-[10px] bg-slate-100 px-1.5 py-0.5 rounded">Switch</span>
                  </button>

                  <button
                    onClick={() => handleDemoSwitch('COUNSELOR', 'dr.sarah@mindtrack.edu')}
                    className="w-full text-left px-3 py-2 rounded-xl text-xs hover:bg-slate-50 flex items-center justify-between text-slate-700"
                  >
                    <div>
                      <p className="font-semibold">Dr. Sarah Chen</p>
                      <p className="text-[10px] text-slate-500">Lead Wellness Counselor</p>
                    </div>
                    <span className="text-[10px] bg-slate-100 px-1.5 py-0.5 rounded">Switch</span>
                  </button>

                  <button
                    onClick={() => handleDemoSwitch('ADMIN', 'admin@mindtrack.edu')}
                    className="w-full text-left px-3 py-2 rounded-xl text-xs hover:bg-slate-50 flex items-center justify-between text-slate-700"
                  >
                    <div>
                      <p className="font-semibold">Dean Eleanor Vance</p>
                      <p className="text-[10px] text-slate-500">Campus Administrator</p>
                    </div>
                    <span className="text-[10px] bg-slate-100 px-1.5 py-0.5 rounded">Switch</span>
                  </button>
                </div>
